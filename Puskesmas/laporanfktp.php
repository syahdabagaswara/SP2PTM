        ...
        <div class="content pb-0">
            ...
            <div class="row" style="margin-bottom: 30px">
                <div class="col-lg-4 col-md-4">
                    <h3 style="color:#8c8e8d;"><b>Laporan FKTP</b></h3>
                </div>
                        ...
                        <div class="modal-header">
                         ...
                         <div class="modal-body" >
                            <div class="row form-space">
                                ...
                                <a href='action/Unduh/UnduhLaporanFktp.php?code=' id='pdf' class='unduhdata'><button type='button' class='PDF' data-toggle='modal' data-info=''>PDF</button></a>
                                </div>
                                <div class="col-lg-6 text-center">
                                <a href='action/Unduh/UnduhLaporanFktp-xls.php?code=' id='excel' class='unduhdata'><button type='button' class='Excel' data-toggle='modal' data-info=''>Excel</button></a>
                                </div>                            
                            </div>
                        </div>
                        <div class="modal-footer">
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
               ...
               $(function() {
                ...
                var dataSet = [
                <?php include('action/reportfktp_clientside.php'); ?>                
                ];
              var table=$('#bootstrap-data-table').DataTable({
                ...
                var column = this;
                var select = $('<select class="form-control btn btn-primary placeholder "><option value="">FKTP</option><option value="">Semua</option></select>')
              ...
              $('#bootstrap-data-table tbody').on( 'click', '.unduhdata', function () {
              ...
              $('#bootstrap-data-table tbody').on( 'click', '.detaildata', function () {
                var kode = table.row( $(this).parents('tr') ).data();
                    $.ajax({
                        url: "action/Detail/DetailLaporanFKTP.php",
                        dataType: 'json',
                        type: 'GET',
                        cache:false,
                        data: {
                    ...
                    var data = table.row( $(this).parents('tr') ).data();
                    document.getElementById("pdf").href="action/Unduh/UnduhLaporanFktp.php?code="+data[0];
                    document.getElementById("excel").href="action/Unduh/UnduhLaporanFktp-xls.php?code="+data[0];
                    });
