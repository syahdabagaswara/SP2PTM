        ...
        <div class="content pb-0">
            ...
            <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <form id="tambahdata" method="POST" action="action/TambahFKTP.php">
                            ...
                            <div class="row">
                                <div class="col-lg-6" style="border-right: 1px solid #e5e5e5;">
                                    ...
                                    <div class="row form-space">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            <input  type="text" id="level" name="level"  value="Puskesmas" class="required form-control form-input" readonly>
                                     ...
                                     <div class="row form-space">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            ...
                                            <select data-placeholder="" type="text" id="pelayanan" name="pelayanan" class=" form-control form-input standardSelect required" tabindex="1"> 
                                                <option  class="option" value="" hidden selected>Pilih Jenis Pelayanan</option>
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                    <form id="editdata" method="POST" action="action/UbahFKTP.php">
                        <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col-lg-6" style="border-right: 1px solid #e5e5e5;">
                                    ...
                                    <div class="row form-space">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            <input  type="text" id="ubahlevel" name="ubahlevel"  value="Puskesmas" class="required form-control form-input" readonly>
            ...
            <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="margin: auto 25rem;" >
                    ...
                    <form id="" method="POST" action="action/DeleteFKTP.php">
                        <div class="modal-header">
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
              ...
              var table=$('#bootstrap-data-table').DataTable({
                ...
                "serverSide": true,
                "ajax": "action/fktp_serverside.php",
                "columnDefs": [ {
                     "targets": -1,
                     "data": null,
