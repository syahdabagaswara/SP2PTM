...
include '../koneksi.php';
    ...
    $quer1=mysqli_query($koneksi,"SELECT * FROM report WHERE id_user='$id_user' AND child_id IS NOT NULL AND status='Proses' AND daterequest<='$now' AND duedate>='$now' ");
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                     ...
                     <li class=" menu-item-has-children dropdown">
                        <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="menu-icon" src="../Assets/icons/icon_pelayanan.svg">Pelayanan</a>
                        <ul class="sub-menu children dropdown-menu ">
                            <li><i class="fa fa-circle"></i><a href="penyakit.php">Data Penyakit</a></li>
                            <li><i class="fa fa-circle"></i><a href="kategoripelayanan.php">Data Kategori</a></li>
                        </ul>
                    </li>
                    
                    <li class=" menu-item-has-children dropdown">
                        <a href="#" class=" dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="menu-icon" src="../Assets/icons/icon_surveilans.svg">Surveilans</a>
                        <ul class="sub-menu children dropdown-menu ">
                            <li><i class="fa fa-circle"></i><a href="pasienptm.php">Data Pasien</a></li>
                            <li><i class="fa fa-circle"></i><a href="puskesmas.php">Data Puskesmas</a></li>
                            <li><i class="fa fa-circle"></i><a href="fktp.php">Data FKTP</a></li>
                        </ul>
                    </li>
                    <li class=" menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu ">
                            ...
                            <li><i class="fa fa-circle"></i><a href="laporantahun.php">Laporan Tahunan</a></li>
                            <li><i class="fa fa-circle"></i><a href="laporanbulan.php">Laporan Bulanan</a></li>
                            <li><i class="fa fa-circle"></i><a href="laporanpuskesmas.php">Laporan Puskesmas</a></li>
                            <li><i class="fa fa-circle"></i><a href="laporanfktp.php">Laporan FKTP</a></li>
                        </ul>
                    </li>
                    <li class=" menu-item-has-children dropdown">
