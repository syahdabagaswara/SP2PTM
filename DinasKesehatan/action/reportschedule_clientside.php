...
include '../koneksi.php';
	$user_id=$_SESSION['id'];
	$data=array();
	$result = mysqli_query($koneksi,"SELECT b.id,a.name,b.id_user,b.kode,b.daterelease,b.datecomplete,b.daterequest,b.duedate,b.status FROM user a, report b  where b.id_user='$user_id' AND b.child_id IS NOT null AND b.id_user=a.id AND status='Proses' ");
