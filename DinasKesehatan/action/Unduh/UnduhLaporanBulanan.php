...
for($i=0;$i<$numdisease;$i++){
	...
	$datareport=array();
	$querydata=mysqli_query($koneksi,"SELECT b.id,b.age,b.status,b.gender FROM report a,datareport b WHERE a.child_id='$report_id' AND b.disease_id='$disease_id' AND b.report_id=a.id ");
