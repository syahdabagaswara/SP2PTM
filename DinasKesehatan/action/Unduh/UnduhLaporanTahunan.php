...
$pdf->Cell(335,10,'LAPORAN PROGRAM PENYAKIT TIDAK MENULAR BERBASIS PUSKESMAS ',10,5,'C');
$pdf->Cell(335,0,'DINAS KESEHATAN KABUPATEN SLEMAN YOGYAKARTA',10,5,'C');
$pdf->Cell(335,9,'TAHUN '.$year.'',10,5,'C');
// $pdf->setXY(280,24);
...
for($i=0;$i<$numdisease;$i++){
	...
	$pdf->setXY(50,146);
	$pdf->Cell(10,30,'Kepala Dinas Kesehatan',0,0,'L');
	$pdf->setXY(50,150);
	$pdf->Cell(10,30,'Kab. Sleman',0,0,'L');
	$pdf->setXY(50,165);
	...
	$pdf->Cell(10,30,'Mengetahui,',0,0,'L');
	$pdf->setXY(160,146);
	$pdf->Cell(10,30,'Kepala Bidang P2P',0,0,'L');
	$pdf->setXY(160,150);
	$pdf->Cell(10,30,'Kab. Sleman',0,0,'L');
	$pdf->setXY(160,165);
	$pdf->Cell(10,30,'___________________',0,0,'L');
