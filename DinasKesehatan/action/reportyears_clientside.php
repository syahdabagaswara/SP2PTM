...
include '../koneksi.php';
	$user_id=$_SESSION['id'];
	$data=array();
	$result = mysqli_query($koneksi,"SELECT b.id,a.name,b.id_user,b.kode,b.daterelease,b.datecomplete,b.daterequest,b.duedate,b.status from user a, report b where a.id = '$user_id' AND b.child_id IS NULL AND b.status='Selesai' ");
