   ...
   <?php include('include/navbar.php'); ?> 
        ...
        <div class="content pb-0">
            ...
            <div class="row" style="margin-bottom: 30px">
                <div class="col-lg-3 col-md-6">
                    <h3 style="color:#8c8e8d;"><b>Daftar Penyakit</b></h3>
                </div>
            ...
            <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content" style="width: 600px!important;left: 300px;">
                        <form id="tambahdata" method="POST" action="action/Tambah/TambahPenyakit.php">
                    
                        <div class="modal-header">
                            <a class="modal-title" id="mediumModalLabel">Tambah Daftar Penyakit</a>
                                ...
                                <div class="col-lg-12" style="border-right: 1px solid #e5e5e5;">
                                    <div class="row form-space">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            <input  type="text" id="icdx" name="icdx" placeholder="Masukan Kode ICD X" class="required form-control form-input">
                                    ...
                                    <div class="row form-space">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            <input  type="text" id="penyakit" name="penyakit" placeholder="Masukan Nama Penyakit" class="required form-control form-input">
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content" style="width: 600px!important;left: 300px;">
                    <form id="editdata" method="POST" action="action/Ubah/ubahPenyakit.php">
                        <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col-lg-12" style="border-right: 1px solid #e5e5e5;">
                                    <div class="row form-space">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            <input  type="text" id="ubahid" name="ubahid" placeholder="Masukan Kode ICD X" class="required form-control form-input" hidden>
                                            <input  type="text" id="ubahicdx" name="ubahicdx" placeholder="Masukan Kode ICD X" class="required form-control form-input">
                                        </div>
                                    </div>
                                    <div class="row form-space">
                                        <div class="col-lg-3 text-left">
                                        ...
                                        <div class="col-lg-5 text-left">
                                            <input  type="text" id="ubahpenyakit" name="ubahpenyakit" placeholder="Masukan Nama Penyakit" class="required form-control form-input">  
                                        </div>
                                    </div>     
                                </div>
                            </div>
            ...
            <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="margin: auto 25rem;" >
                    ...
                    <form id="" method="POST" action="action/Hapus/HapusPenyakit.php">
                        <div class="modal-header">
                            <a class="modal-title" id="largeModalLabel">Hapus Data Penyakit</a>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
              ...
              var table=$('#bootstrap-data-table').DataTable({
                ...
                "serverSide": true,
                "ajax": "action/disease_server-side.php",
                "columnDefs": [ {
                     "targets": -1,
                     "data": null,
              ...
              $('#bootstrap-data-table tbody').on( 'click', '.editdata', function () {
                    ...
                    $('#ubahlabel').text(data[2]);
                    $('#ubahid').val(data[0]);
                    $('#ubahicdx').val(data[1]);
                    $('#ubahpenyakit').val(data[2]);
                    });
    ...
    <script type="text/javascript"> 
        $(document).ready(function () {
            ...
            messages: {
                    icdx: {required: "Kode ICD X tidak boleh kosong!"},
                    name: {required: "Nama Penyakt tidak boleh kosong!"}
                    },
