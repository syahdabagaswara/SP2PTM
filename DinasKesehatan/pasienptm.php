            ...
            $(document).ready(function() {
               ...
               $(function() {
                ...
                <?php for ($i = 0; $i < $rowresult; $i++){ 
                    echo '[ "'.$data[$i]['id'].'","'.$data[$i]['report_id'].'","'.$data[$i]['nik'].'","'.$data[$i]['name'].'","'.$data[$i]['birthdate'].'","'.$data[$i]['penyakit'].'","'.$data[$i]['visitdate'].'","'.$data[$i]['gender'].'","'.$data[$i]['status'].'","'.$data[$i]['age'].'","'.$data[$i]['idd'].'"],';
                    } 
                ?>];
              var table=$('#bootstrap-data-table').DataTable({
                ...
                "columnDefs": [ {
                     ...
                     "defaultContent": "<button type='button' class='detaildata' data-toggle='modal' data-target='#largeModal1' data-info=''>Detail</button>"},
                    {
                        "targets": [ 0 ],
                        "visible": false
