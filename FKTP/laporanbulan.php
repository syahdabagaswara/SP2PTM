        ...
        <div class="content pb-0">
            ...
            <div class="row" style="margin-bottom: 30px">
                <div class="col-lg-4 col-md-4">
                    <h3 style="color:#8c8e8d;"><b>Laporan Bulanan</b></h3>
                </div>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
               ...
               $("#unduhexcel").on("click", function() {
                ...
                var dataSet = [
                <?php include('action/reportmonth_clientside.php'); ?>  ];
              ...
              $('#bootstrap-data-table tbody').on( 'click', '.detaildata', function () {
                    ...
                    $.ajax({
                        url: "action/Detail/DetailLaporanBulanan.php",
                        dataType: 'json',
                        type: 'GET',
                        cache:false,
                        data: {
                    ...
                    document.getElementById("pdf").href="action/Unduh/UnduhLaporanBulanan.php?code="+data[0];
                    document.getElementById("excel").href="action/Unduh/UnduhLaporanBulanan-xls.php?code="+data[0];
                    });
